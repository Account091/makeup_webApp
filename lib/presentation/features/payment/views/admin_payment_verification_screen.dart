                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text('Ref: ${item.bookingId}', style: AppTextStyles.sectionHeader),
                          Row(
                            children: [
                              Container(
                      ...
                      Row(
                        ...
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Customer: ${item.customerName}', style: AppTextStyles.bodyPrimary),
                              Text('Phone: ${item.customerPhone}', style: AppTextStyles.bodySecondary),
                            ],
                          ),
                          Column(
